...
import { V_MODEL_CHECKBOX, V_MODEL_DYNAMIC, V_MODEL_RADIO, V_MODEL_SELECT, V_MODEL_TEXT } from '../../src/runtimeHelpers';
    ...
    describe('errors', () => {
        test('plain elements with argument', () => {
            ...
            expect(onError).toHaveBeenCalledWith(expect.objectContaining({
                code: 58 /* X_V_MODEL_ARG_ON_ELEMENT */
            }));
        });
        test('invalid element', () => {
            ...
            expect(onError).toHaveBeenCalledTimes(1);
            expect(onError).toHaveBeenCalledWith(expect.objectContaining({
                code: 57 /* X_V_MODEL_ON_INVALID_ELEMENT */
            }));
        });
        test('should raise error if used file input element', () => {
            ...
            expect(onError).toHaveBeenCalledWith(expect.objectContaining({
                code: 59 /* X_V_MODEL_ON_FILE_INPUT_ELEMENT */
            }));
        });
    });
    describe('modifiers', () => {
