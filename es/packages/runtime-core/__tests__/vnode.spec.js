...
import { ShapeFlags, Comment, Fragment, Text, cloneVNode } from '@vue/runtime-core';
...
describe('vnode', () => {
    ...
    test('type shapeFlag inference', () => {
        ...
        expect(createVNode(() => { }).shapeFlag).toBe(ShapeFlags.FUNCTIONAL_COMPONENT);
    ...
    describe('mergeProps', () => {
        test('class', () => {
            let props1 = { class: 'c' };
            let props2 = { class: ['cc'] };
            let props3 = { class: [{ ccc: true }] };
            let props4 = { class: { cccc: true } };
        ...
        test('handlers', () => {
            ...
            let props1 = { onClick: clickHander1 };
            let props2 = { onClick: clickHander2, onFocus: focusHander2 };
            expect(mergeProps(props1, props2)).toMatchObject({
        ...
        test('default', () => {
            let props1 = { foo: 'c' };
            let props2 = { foo: {}, bar: ['cc'] };
            let props3 = { baz: { ccc: true } };
