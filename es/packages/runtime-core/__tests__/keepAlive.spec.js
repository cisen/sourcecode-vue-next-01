import { h, nodeOps, render, ref, KeepAlive, serializeInner, nextTick } from '@vue/runtime-test';
describe('keep-alive', () => {
    let one;
    let two;
    let views;
    ...
    async function assertNameMatch(props) {
    ...
    describe('cache invalidation', () => {
        ...
        async function assertAnonymous(include) {
            const one = {
                name: 'one',
                created: jest.fn(),
                render: () => 'one'
