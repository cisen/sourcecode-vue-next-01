import { onMounted, onErrorCaptured, render, h, nodeOps, watch, ref, nextTick, mockWarn, createComponent } from '@vue/runtime-test';
describe('error handling', () => {
    ...
    it('should warn unhandled', () => {
        ...
        render(h(Comp), nodeOps.createElement('div'));
        expect(fn).toHaveBeenCalledWith(err, 'setup function');
        expect(`Unhandled error during execution of setup function`).toHaveBeenWarned();
