import { h, nodeOps, render, serializeInner, triggerEvent, nextTick, renderToString, ref, createComponent, mockWarn } from '@vue/runtime-test';
describe('api: options', () => {
    ...
    describe('warnings', () => {
        ...
        test('assigning to computed with no setter', () => {
            ...
            render(h(Comp), root);
            instance.foo = 1;
            expect('Computed property "foo" was assigned to but it has no setter.').toHaveBeenWarned();
        });
        test('data property is already declared in props', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Data property "foo" is already defined in Props.`).toHaveBeenWarned();
        });
        test('computed property is already declared in data', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Computed property "foo" is already defined in Data.`).toHaveBeenWarned();
        });
        test('computed property is already declared in props', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Computed property "foo" is already defined in Props.`).toHaveBeenWarned();
        });
        test('methods property is not a function', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Method "foo" has type "number" in the component definition. ` +
                `Did you reference the function correctly?`).toHaveBeenWarned();
        });
        test('methods property is already declared in data', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Methods property "foo" is already defined in Data.`).toHaveBeenWarned();
        });
        test('methods property is already declared in props', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Methods property "foo" is already defined in Props.`).toHaveBeenWarned();
        });
        test('methods property is already declared in computed', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Methods property "foo" is already defined in Computed.`).toHaveBeenWarned();
        });
        test('inject property is already declared in data', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Inject property "a" is already defined in Data.`).toHaveBeenWarned();
        });
        test('inject property is already declared in props', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Inject property "a" is already defined in Props.`).toHaveBeenWarned();
        });
        test('inject property is already declared in computed', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Inject property "a" is already defined in Computed.`).toHaveBeenWarned();
        });
        test('inject property is already declared in methods', () => {
            ...
            const root = nodeOps.createElement('div');
            render(h(Comp), root);
            expect(`Inject property "a" is already defined in Methods.`).toHaveBeenWarned();
        });
    });
});
