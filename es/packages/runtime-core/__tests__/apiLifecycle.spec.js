import { onBeforeMount, h, nodeOps, render, serializeInner, onMounted, ref, onBeforeUpdate, nextTick, onUpdated, onBeforeUnmount, onUnmounted, onRenderTracked, reactive, onRenderTriggered } from '@vue/runtime-test';
