...
import { EMPTY_OBJ, isFunction, capitalize, NOOP, isObject, NO, makeMap, isPromise } from '@vue/shared';
    ...
    if (!instance.render) {
        ...
        if (__DEV__ && !Component.render) {
            ...
            if (!__RUNTIME_COMPILE__ && Component.template) {
                ...
                warn(`Component is missing${__RUNTIME_COMPILE__ ? ` template or` : ``} render function.`);
            }
        }
