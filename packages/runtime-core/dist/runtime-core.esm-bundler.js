import { toRaw, isReactive, unlock, lock, readonly, effect, stop, isRef, pauseTracking, resumeTracking, reactive, computed as computed$1 } from '@vue/reactivity';
...
export { Comment, Fragment, KeepAlive, PatchFlags, Portal, PublicShapeFlags as ShapeFlags, Suspense, Text, callWithAsyncErrorHandling, callWithErrorHandling, camelize$1 as camelize, capitalize$1 as capitalize, cloneVNode, computed, createBlock, createCommentVNode, createComponent, createHook, createRenderer, createSlots, createTextVNode, createVNode, getCurrentInstance, h, handleError, inject, injectHook, instanceWatch, mergeProps, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onUnmounted, onUpdated, openBlock, provide, recordEffect, registerRuntimeCompiler, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, setBlockTracking, toHandlers, toString, version, warn, watch, withDirectives };
